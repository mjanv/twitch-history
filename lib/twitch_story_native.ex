defmodule TwitchStoryNative do
  @moduledoc """
  ...
  import TwitchStoryWeb, only: [verified_routes: 0]
  ...
  def live_view do
    quote do
      use LiveViewNative.LiveView,
        ...
        layouts: [
          swiftui: {TwitchStoryWeb.Layouts.SwiftUI, :app}
        ]
  ...
  defp helpers(format) do
    ...
    core_component_module = Module.concat([TwitchStoryWeb, CoreComponents, plugin.module_suffix])
