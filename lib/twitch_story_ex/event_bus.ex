defmodule TwitchStory.EventBus do
  @moduledoc """
  Event bus

  The event bus is used to dispatch events to all registered dispatchers. A dispatcher is any module that implements the `use TwitchStory.EventBus.Dispatcher` behaviour. The list of dispatchers is defined in the `config/` folder.
  """
