defmodule TwitchStoryWeb.CoreComponents.SwiftUI do
  @moduledoc """
  ...
  of the `TwitchStoryWeb.CoreComponents` functions you should expect identical functionality for similarly named
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TwitchStoryWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TwitchStoryWeb.Gettext, "errors", msg, opts)
    end
  end
